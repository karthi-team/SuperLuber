...
class UserController extends Controller
{
    ...
    $delivery_sub_monthly_total = DB::table('sales_order_delivery_sublist_c')
       ...
       $all_values = DealerCreation::join($sales_rep_td, $sales_rep_td.'.id', '=', $dealer_td.'.sales_rep_id')
        ...
        // $c_to_d = SalesReturnD2CSub::where(function($query) {
        //     $query->where('delete_status', '0')->orWhereNull('delete_status');
        // })->count();
...
//     $delivery_monthly_data = [];
//     for ($d = 1; $d <= 12; $d++)
//     {
//         $monthly_delivery = DB::table('SalesOrderDeliverySub')
//             ->selectRaw('SUM(total_amount) as monthly_delivery')
//             ->where(function ($query) {
//                 $query->where('delete_status', 0)
//                     ->orWhereNull('delete_status');
//             })
...
//         $delivery_monthly_data[] = $monthly_delivery;
//     }
// return $delivery_monthly_data;
        return view('dashboard.admin', [
            ...
            // 'delivery_monthly_data'=>json_encode($delivery_monthly_data),
        ]);
    }
}
