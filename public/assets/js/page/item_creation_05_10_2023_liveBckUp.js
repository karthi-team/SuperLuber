...
function insert_update_row(id,category_id,group_id,item_name,item_liters_type_id,item_properties_type_id,distributor_rate,description,hsn_code,piece)
{

  if(id=="")
  {
    if((category_id)&&(group_id)&&(item_name)&&(item_liters_type_id)&&(item_properties_type_id)&&(distributor_rate)){

    var sendInfo={"action":"insert","category_id":category_id,"group_id":group_id,"item_name":item_name,'item_liters_type_id':item_liters_type_id,'item_properties_type_id':item_properties_type_id,"distributor_rate":distributor_rate,'description':description,'hsn_code':hsn_code,'piece':piece};
    $.ajax({
      type: "GET",
      url: $("#CUR_ACTION").val(),
      data: sendInfo,
    ...
    validate_inputs(category_id,group_id,item_name,item_liters_type_id,item_properties_type_id,distributor_rate);
  }
  }
  else
  {
    ...
    var sendInfo={"action":"update","id":id,"category_id":category_id,"group_id":group_id,"item_name":item_name,'item_liters_type_id':item_liters_type_id,'item_properties_type_id':item_properties_type_id,"distributor_rate":distributor_rate,'description':description,'hsn_code':hsn_code,'piece':piece};
    $.ajax({
      type: "GET",
      url: $("#CUR_ACTION").val(),
      data: sendInfo,
...
function validate_inputs(category_id,group_id,item_name,item_liters_type_id,item_properties_type_id,distributor_rate)
{
  if(category_id==="")
