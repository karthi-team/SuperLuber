...
function insert_update_row(id,category_name,description,status)
{
  ...
  if(id=="")
  {
    if((category_name))
    {
    var sendInfo={"action":"insert","category_name":category_name,"description":description,"status":status};
    $.ajax({
      type: "GET",
      url: $("#CUR_ACTION").val(),
      data: sendInfo,
  ...
  else{validate_inputs(category_name);}
  }
  else
  {
    if((category_name))
    {
    var sendInfo={"action":"update","id":id,"category_name":category_name,"description":description,"status":status};
    $.ajax({
      type: "GET",
      url: $("#CUR_ACTION").val(),
      data: sendInfo,
...
function validate_inputs(category_name)
{

  if(category_name==='') {$("#category_name").addClass('is-invalid'); $("#category_name_validate_div").html("Enter Category Name"); return false;} else { $("#category_name").removeClass('is-invalid'); $("#category_name_validate_div").html("");}
