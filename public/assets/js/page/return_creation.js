...
function insert_update_row(id,return_type,description)
{


  if(id=="")
  {
    var sendInfo={"action":"insert","return_type":return_type,"description":description};
    $.ajax({
      type: "GET",
      url: $("#CUR_ACTION").val(),
      data: sendInfo,
  ...
  {
    var sendInfo={"action":"update","id":id,"return_type":return_type,"description":description};
    $.ajax({
      type: "GET",
      url: $("#CUR_ACTION").val(),
      data: sendInfo,
