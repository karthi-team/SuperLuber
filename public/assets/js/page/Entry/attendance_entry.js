function list_div(from_date_1, to_date_1, category_type_1)
{
  $('#list_div').html("");
  var sendInfo={"action":"retrieve","from_date_1": from_date_1, "to_date_1": to_date_1, "category_type_1":category_type_1};
  $.ajax({
    type: "GET",
    url: $("#CUR_ACTION").val(),
    data: sendInfo,
