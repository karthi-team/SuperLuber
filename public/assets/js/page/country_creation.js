...
function insert_update_row(id,country_name,description)
{
  if(id=="")
  {
    var sendInfo={"action":"insert","country_name":country_name,"description":description};
    $.ajax({
        type: "GET",
        url: $("#CUR_ACTION").val(),
        data: sendInfo,
  ...
  {
    var sendInfo={"action":"update","id":id,"country_name":country_name,"description":description};
    $.ajax({
        type: "GET",
        url: $("#CUR_ACTION").val(),
        data: sendInfo,
...
function delete_row(id)
{
  swal({
    title: 'Are you sure?',
    text: 'To delete Country Creation',
    icon: 'warning',
    buttons: true,
    dangerMode: true,
  })
