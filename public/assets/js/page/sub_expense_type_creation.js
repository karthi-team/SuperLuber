...
function insert_update_row(id,expense_type,sub_expense_type,description)
{

    
  if(id=="")
  {
    var sendInfo={"action":"insert","expense_type":expense_type,"sub_expense_type":sub_expense_type,"description":description};
    $.ajax({
      type: "GET",
      url: $("#CUR_ACTION").val(),
      data: sendInfo,
  ...
  {
    var sendInfo={"action":"update","id":id,"expense_type":expense_type,"sub_expense_type":sub_expense_type,"description":description};
    $.ajax({
      type: "GET",
      url: $("#CUR_ACTION").val(),
      data: sendInfo,
