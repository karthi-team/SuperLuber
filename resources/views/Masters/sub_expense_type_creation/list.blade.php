...
<div class="table-responsive">
    ...
    <tr align="centre">
        ...
        <td class="stl"><?php echo  ucfirst($expense_type1['sub_expense_type']); ?></td>
        ...
        <a class="btn btn-icon icon-left btn-info" data-toggle="tooltip" title="Edit" onclick="open_model('Update Sub Expense Type','<?php echo $expense_type1['id']; ?>')"><i class="far fa-edit"></i>Edit</a>
        <?php } ?>
