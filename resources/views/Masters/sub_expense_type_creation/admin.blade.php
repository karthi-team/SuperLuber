...
@section('page_title','Sub Expense Type Creation')
@section('header_content')
@endsection
@section('main_content')
<input type="hidden" id="CUR_ACTION" value="{{ route('sub_expense_type_creation_Action') }}" />
<input type="hidden" id="design" value="Add Sub Expense Creation">
<div class="row">
  <div class="col-md-12">
    <div class="card">
      <div class="card-header">
        <h4><span class="label info small">Sub Expense Master</span></h4>
        <div class="card-header-action" id="user_rights_add_div">
            <button type="submit" class="button" onclick="open_model('Sub Expense Creation','')">Create</button>
...
<script src="{!! asset('assets/js/page/sub_expense_type_creation.js') !!}"></script>
@endsection
