...
@section('page_title','Item Creation')
@section('header_content')
@endsection
@section('main_content')
<input type="hidden" id="CUR_ACTION" value="{{ route('Item_Creation_Action') }}" />
<div class="row">
  <div class="col-md-12">
    <div class="card">
      <div class="card-header">
        <h4> <span class="label info small">Item Master</span> </h4>
        <div class="card-header-action" id="user_rights_add_div">
            <button type="submit" class="button" onclick="open_model('Item Creation','')">Create</button>
...
<script src="{!! asset('assets/js/page/item_creation.js') !!}"></script>
@endsection
