<div class="container">
    <div class="row justify-content-center">
      <div class="col-md-6">
<form onsubmit="return validateForm()" action="javascript:insert_update_row('<?php echo $country_creation['id']; ?>',country_name.value,description.value)">

            <div class="form-group">
                 <label class="stl">Country Name</label> <label style="color:red">*</label>
                <input type="text" id="country_name" class="form-control" value="<?php echo $country_creation['country_name']; ?>" >
            ...
            <div class="form-group">
                ...
                <textarea class="form-control" id="description" name="description" rows="4"><?php echo $country_creation['description']; ?></textarea>
            </div>
    <div class="row">
        <div class="col-md-6">
