...
<div class="table-responsive">
    ...
    <tr align="center">
        ...
        <td class="stl"><?php echo  ucfirst($district_creation1['machine_id']); ?></td>
        <td class="stl"><?php echo  ucfirst($district_creation1['machine_name']); ?></td>
        <td class="stl"><?php echo  ucfirst($district_creation1['machine_type']); ?></td>

        <td class="stl"><?php echo  ucfirst($district_creation1['model_number']); ?></td>
        <td class="stl"><?php echo  ucfirst($district_creation1['purchase_date']); ?></td>
