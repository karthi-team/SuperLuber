...
@section('page_title','Advance Creation')
@section('header_content')
@endsection
@section('main_content')
<input type="hidden" id="CUR_ACTION" value="{{ route('advance_creation_Action') }}" />
<div class="row">
  <div class="col-md-12">
    <div class="card">
      <div class="card-header">
        <h4 class="talk-bubble">
            <span class="label info small">Advance Master</span></h4>
            <div class="card-header-action" id="user_rights_add_div">

                <button type="submit" class="button" onclick="open_model('Advance Creation','')">Create</button>
...
<script src="{!! asset('assets/js/page/advance_creation.js') !!}"></script>
@endsection
