...
@section('page_title','District Creation')
@section('header_content')
@endsection
@section('main_content')
<input type="hidden" id="CUR_ACTION" value="{{ route('District_Creation_Action') }}" />
<div class="row">
  <div class="col-md-12">
    <div class="card">
      <div class="card-header">
        <h4><span class="label info small">District Master</span></h4>
        <div class="card-header-action" id="user_rights_add_div">
            <button type="submit" class="button" onclick="open_model('District Creation','')">Create</button>
...
<script src="{!! asset('assets/js/page/district_creation.js') !!}"></script>
@endsection
