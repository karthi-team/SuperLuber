...
@section('page_title','Sales Rep Creation')
@section('header_content')
@endsection
@section('main_content')
<input type="hidden" id="_token2" value="{{ csrf_token() }}" />
<input type="hidden" id="CUR_ACTION" value="{{ route('Sales_Rep_Creation_Action') }}" />
<div class="row"> 
  <div class="col-md-12">
    <div class="card">
      <div class="card-header">
        <h4> <span class="label info small">Sales Rep Master</span></h4>
        <div class="card-header-action" id="user_rights_add_div">
            <button type="submit" class="button" onclick="open_model('Sales Rep Creation','')">Create</button>
...
<script src="{!! asset('assets/js/page/sales_rep_creation.js') !!}"></script>
@endsection
