...
<div class="table-responsive">
    ...
    <tr align="center">
        ...
        <td class="stl"><?php echo  ucfirst($market_creation1['id']); ?></td>
        <td class="stl"><?php echo  ucfirst($market_creation1['state_name']); ?></td>
        <td class="stl"><?php echo  ucfirst($market_creation1['district_name']); ?></td>
        <td class="stl"><?php echo  ucfirst($market_creation1['area_name']); ?></td>
        ...
        <a class="btn btn-icon icon-left btn-info hover-gradient" data-toggle="tooltip" style="cursor: pointer" title="Edit" onclick="open_model('Update Market Creation','<?php echo $market_creation1['id']; ?>')"><i class="far fa-edit"></i>Edit</a>
        <?php } ?>
