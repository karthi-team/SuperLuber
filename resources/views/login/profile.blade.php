                        ...
                        <div class="card-body">
                            <div class="d-flex flex-column align-items-center text-center">
                                {{-- <img src="https://bootdey.com/img/Content/avatar/avatar7.png" alt="Admin"
                                    ...
                                    <img src="{{ asset('storage/barang/'.$employee_creation->image_name) }}" alt="Employee Image" width="200" height="200">
                                <div class="mt-3">
                                    <h4>{{ $employee_creation->sales_ref_name }}</h4>
                        ...
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="col-sm-9 text-secondary">
                                    {{ $employee_creation->sales_ref_name }}
                                </div>
                            </div>
                            {{-- <hr>
                            <div class="row">
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-9 text-secondary">
                                   +91 {{$employee_creation->mobile_no}}
                                </div>
                            </div>
                            <hr>
                            <div class="row">
