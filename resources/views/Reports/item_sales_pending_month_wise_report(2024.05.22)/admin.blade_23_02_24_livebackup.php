    ...
    <div class="card">
      ...
      <div class="card-body">
        <div class="row">
          ...
          <div class="col-md-3">
            <div class="form-group">
                <label for="group_by" style="color: green;"><strong>Consolidate</strong></label>
          ...
          <div class="col-md-3">
            <div class="form-group">
                <label>&nbsp;</label><br>
                <button class="btn btn-info" onclick="list_div(from_date.value, to_date.value, sales_ref_id.value, item_id.value, manager_id.value, dealer_id.value, sales_det.value)">GO</button>
            </div>
