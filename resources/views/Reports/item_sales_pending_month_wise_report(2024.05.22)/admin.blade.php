        ...
        <div class="row">
          ...
          <div class="col-md-3">
            <div class="form-group">
              ...
              <select class="form-control select2" id="manager_id" width="100%"  onchange="find_sales_ref();disableFields()" >
          ...
          <div class="col-md-3">
            <div class="form-group">
                ...
                <select class="form-control select2" id="group_by" width="100%" onchange="disableFields()">
                    <option value="">Select</option>
          ...
          <div class="col-md-3">
            <div class="form-group">
                ...
                <select class="form-control select2" id="ref_by" width="100%" onchange="disableFields1()">
                    <option value="">Select</option>
          ...
          <div class="col-md-3">
            <div class="form-group">
              <label for="item_id">Dealer Name</label>
          ...
          <div class="col-md-3">
            <div class="form-group">
                <label>&nbsp;</label><br>
                <button class="btn btn-info" onclick="list_div(from_date.value, to_date.value, sales_ref_id.value, item_id.value, manager_id.value, dealer_id.value, sales_det.value, ref_by.value)">GO</button>
            </div>
