                    ...
                    @foreach ($item_creation as $item_creations)
                        ...
                        @foreach ($order_delivery as $order_deliverys)
                            ...
                            @php
                                ...
                                $cnt_bal+=$balance_qty;
                            @endphp
                                <td class="green-background">{{ $balance_qty }}</td>
                                <td class="green-background">{{ $order_deliverys->total_order_quantity - $order_deliverys->total_balance_quantity}}</td>
                        ...
                        @foreach ($sub_value as $sub_value_s)
                            ...
                            @endphp
                                ...
                                @if (!$found)
                                    <td>0</td>
                                    <td bgcolor="#59e1d5">{{ $jer_balen}}</td>
