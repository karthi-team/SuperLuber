...
@section('page_title','Sales Order Report (COMPANY TO DEALER)')
@section('header_content')
<link rel="stylesheet" type="text/css" href="../assets/css/page/button.css">
@endsection
@section('main_content')
<input type="hidden" id="CUR_ACTION" value="{{ route('Sales_Order_Report_C2D_Action') }}" />
<div class="row">
  <div class="col-md-12">
    <div class="card">
      <div class="card-header">
        <h4><span class="label info small">Sales Order Report (COMPANY TO DEALER)</span></h4>
        {{-- <div class="card-header-action" id="user_rights_add_div">
          <button type="submit" class="button" onclick="open_model(' Sales Order (COMPANY TO DEALER)','')">Create</button>
        </div> --}}
      </div>
      <div class="card-body">
        <div class="row">
...
<script src="../assets/js/page/Reports/sales_order_report_c2d.js"></script>
@endsection
