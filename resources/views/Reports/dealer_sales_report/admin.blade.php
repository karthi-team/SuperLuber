        ...
        <div class="row">
          ...
          <div class="col-md-3">
            <div class="form-group">
              ...
              <select class="form-control select2" id="item_id" width="100%" onchange=''>
                <option value="">Select</option>
          ...
          <div class="col-md-2">
            <div class="form-group">
              <label>&nbsp;</label><br>
              <button class="btn btn-info" onclick="list_div_1(from_date.value,to_date.value,dealer_id.value,group_id.value,item_id.value,manager_na.value,excutive_id.value)">GO</button>
            </div>
          </div>
        </div>
      </div>
