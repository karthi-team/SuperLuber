      ...
      <div class="card-body">
        <div class="row">
          ...
          <div class="col-md-1">
            <div class="form-group">
              <label>&nbsp;</label><br>
              <button class="btn btn-info" onclick="list_div1(from_date.value,to_date.value,dealer_name.value,area_name.value,shop_type.value,pur_time.value,group_id.value,item_id.value,pur_volumn.value)">GO</button>
            </div>
          </div>
        </div>
      </div>
      <div id="listpage">
        @include('../Reports/shop_report/list')
      </div>
    </div>
  </div>
</div>
