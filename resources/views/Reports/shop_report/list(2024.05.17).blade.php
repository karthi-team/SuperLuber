        ...
        <div class="table-responsive">
            ...
            <tbody>
                @php
                    ...
                    $total_product_purs = 0;
                    $total_product_ntpurs = 0;
                    $total_product_ltr = 0;
                ...
                @foreach($list as $lists)
                    <tr>
                        ...
                        <td>
                            @unless($lists->product_purchased == 0)
                                {{ $lists->product_purchased }}
                            @else
                                -
                            @endunless
                        </td>
                        <td>
                            @unless($lists->product_not_purchased == 0)
                                {{ $lists->product_not_purchased }}
                            @else
                                -
                            @endunless
                        </td>
                    ...
                    @php
                        ...
                        $total_product_purs+=$lists->product_purchased;
                        $total_product_ntpurs+=$lists->product_not_purchased;
            ...
            <tr>
                ...
                <td style="background-color:rgb(117, 157, 231); color:white">{{ $total_product_purs }} </td>
                <td style="background-color:rgb(201, 207, 107);">{{ $total_product_ntpurs }}</td>
