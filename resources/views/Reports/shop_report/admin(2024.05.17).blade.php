        ...
        <div class="row">
          ...
          <div class="col-md-2">
            <div class="form-group">
              ...
              <select class="form-control select2" onchange="get_sales_ref()" id="manager_id" width="100%">
          ...
          <div class="col-md-2">
            <div class="form-group">
              ...
              <select class="form-control select2" id="sales_ref_id" width="100%" onchange="get_dealer()" >
                <option value="">Select</option>
          ...
          <div class="col-md-2">
            <div class="form-group">
              ...
              <select class="form-control select2" id="dealer_name" width="100%" onchange='get_area_name()' >
                <option value="">Select</option>
          ...
          <div class="col-md-2">
            <div class="form-group">
              ...
              <select class="form-control select2" id="area_name" width="100%" onchange='get_shop_type()'>
                <option value="">Select</option>
          ...
          <div class="col-md-1">
            <div class="form-group">
              <label>&nbsp;</label><br>
              <button class="btn btn-info" onclick="list_div(from_date.value,to_date.value,manager_id.value,sales_ref_id.value,dealer_name.value,area_name.value,shop_type.value,pur_time.value,group_id.value,item_id.value,pur_volumn.value)">GO</button>
            </div>
          </div>
        </div>
      </div>
