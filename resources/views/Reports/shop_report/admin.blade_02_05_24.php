        ...
        <div class="row">
          <div class="col-md-2">
            <div class="form-group">
              ...
              <input type="date" class="form-control" id="from_date" onclick="fromdate()" value="<?php echo date("Y-m-d"); ?>" />
            </div>
          </div>
          <div class="col-md-2">
            <div class="form-group">
              <label for="to_date">To Date</label>
              <input type="date" class="form-control" id="to_date" onclick="todate()" value="<?php echo date("Y-m-t"); ?>" />
            </div>
          </div>
          ...
          <div class="col-md-1">
            <div class="form-group">
              <label>&nbsp;</label><br>
              <button class="btn btn-info" onclick="list_div(from_date.value,to_date.value,dealer_name.value,area_name.value,shop_type.value,pur_time.value,group_id.value,item_id.value,pur_volumn.value)">GO</button>
            </div>
          </div>
        </div>
      </div>
