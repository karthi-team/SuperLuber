        ...
        <div class="table-responsive">
            <thead>
               <tr>
                    ...
                    <th style="width: 8%; display: none;">Order Not Taken Shop</th>
                    <th style="width: 8%; display: none;">Order Taken Shop</th>
            ...
            <tbody>
                ...
                foreach ($sales_order_d2s_main as $sales_order_d2s_main1) {
                    ...
                    <tr>
                        ...
                        <td style="display: none;"><?php echo $sales_order_d2s_main1->shop_names; ?></td>

                        <td style="display: none;"><?php echo $sales_order_d2s_main1->shop_names_1; ?></td>

                        <td>
                            <a class="btn btn-icon icon-left btn-warning" data-toggle="tooltip" style="cursor: pointer" title="Market" onclick="showDetails(this)"><i class="fas fa-eye"></i>View</a>
                        </td>
                    </tr>
                <?php } ?>
            </tbody>
