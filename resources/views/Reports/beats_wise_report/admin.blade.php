        ...
        <div class="row">
          ...
          <div class="col-md-2">
            <div class="form-group">
              ...
              <select class="form-control select2" id="dealer_id" width="100%" onchange="find_beats()">
          ...
          <div class="col-md-2">
            <div class="form-group">
              ...
              <select class="form-control select2" id="beats_id" width="100%" onchange="find_shop_type()">
                <option value="">Select</option>
          ...
          <div class="col-md-2">
            <div class="form-group">
              ...
              <select class="form-control select2" id="shop_type" width="100%"  onchange="find_shop_name()">
                <option value="">Select</option>
          ...
          <div class="col-md-2">
            <div class="form-group">
              <label>&nbsp;</label><br>
              <button class="btn btn-info" onclick="list_div(from_date.value,to_date.value,dealer_id.value,beats_id.value,shop_id.value,shop_type.value)">GO</button>
            </div>
          </div>
        </div>
      </div>
