...
@section('page_title','Notification for Sales Ref')
...
<input type="hidden" id="CUR_ACTION" value="{{ route('notification_for_sales_ref_Action') }}" />
  ...
  <div class="col-md-12">
    <div class="card">
      <div class="card-header">
        <h4><span class="label info small">Notification Sales Ref</span></h4>
        <div class="card-header-action" id="user_rights_add_div">
            <button type="submit" class="button" onclick="open_model('Notification for Sales Ref','')">Create</button>
...
<script src="{!! asset('assets/js/page/Notifications/notification_for_sales_ref.js') !!}"></script>
@endsection
