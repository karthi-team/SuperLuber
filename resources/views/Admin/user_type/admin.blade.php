...
@section('page_title','User Type')
@section('header_content')
<link rel="stylesheet" type="text/css" href="../assets/css/page/button.css">
@endsection
@section('main_content')
<input type="hidden" id="CUR_ACTION" value="{{ route('User_Type_Action') }}" />
<div class="row">
  <div class="col-md-12">
    <div class="card">
      <div class="card-header">
        <h4><span class="label info small">User Type</span></h4>
        <div class="card-header-action" id="user_rights_add_div">
          <button type="submit" class="button" onclick="open_model(' User Type','')">Create</button>
        </div>
      </div>
...
<script src="../assets/js/page/Admin/user_type.js"></script>
@endsection
