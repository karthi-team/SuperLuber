...
@section('page_title','Order Dispatch (C -> D)')
...
<input type="hidden" id="CUR_ACTION" value="{{ route('Sales_Order_Delivery_Action') }}" />
{{-- <input type="hidden" id="_token" value="{{ csrf_token() }}" /> --}}
<div class="row">
  <div class="col-md-12">
    <div class="card">
      <div class="card-header">
        <h4><span class="label info small">Order Dispatch (C -> D)</span></h4>
        <div class="card-header-action" id="user_rights_add_div">
          <button type="submit" class="button" onclick="open_model(' Order Dispatch (C -> D)','')">Create</button>
        </div>
      </div>
      <div class="card-body">
        <div class="row">
          ...
          <div class="col-md-2">
            <div class="form-group">
              ...
              <select class="form-control select2" id="sales_exec_1" name= 'tableExport 'width="100%" onchange='getdearlername1()'>
          ...
          <div class="col-md-3">
            <div class="form-group">
              ...
              <select class="form-control select2" id="dealer_creation_id_1" width="100%" onchange='marketname()'>
                <option value="">Select</option>
          ...
          <div class="col-md-2">
            <div class="form-group">
              <label for="delivery_no_1">Delivery Number</label>
              <select class="form-control select2" id="delivery_no_1" width="100%">
                <option value="">Select</option>
                <?php foreach($delivery_no_list as $delivery_no_list1){ ?>
                <option value="<?php echo $delivery_no_list1['delivery_no']; ?>"><?php echo $delivery_no_list1['delivery_no']; ?></option>
                <?php } ?>
              </select>
            </div>
          </div>
          <div class="col-md-1">
            <div class="form-group">
              <label>&nbsp;</label><br>
              <button class="btn btn-info" onclick="list_div(from_date_1.value,to_date_1.value,sales_exec_1.value,dealer_creation_id_1.value,delivery_no_1.value)">GO</button>
            </div>
          </div>
        </div>
      </div>
...
<script src="../assets/js/page/Entry/sales_order_delivery.js"></script>
@endsection
