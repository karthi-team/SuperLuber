<form action="javascript:insert_update_row('',dispatch_date.value,delivery_no.value,order_recipt_no.value,sales_exec.value,dealer_creation_id.value,status1.value,driver_name.value,driver_number.value,vehile_name.value,tally_no.value,description.value,desc.value)">
<div class="row">
    <div class="col-md-2">
    ...
    <div class="col-md-2" style="display: none;">
        <div class="form-group">
            ...
            <select class="form-control" id="desc" name="desc">
                <?php foreach($order_no as $order_no1): ?>
                    <option value="<?php echo $order_no1['id']; ?>"><?php echo $order_no1['description']; ?></option>
                <?php endforeach; ?>
            </select>
        </div>
    </div>
