<form
    action="javascript:insert_update_row('',order_date.value,dealer_creation_id.value,dealer_address.value,mop.value,order_no.value,status1.value,credit_note_no.value,description.value,sales_exec.value)">
    <div class="row">
        <div class="col-md-2">
    ...
    <div class="col-md-2">
        <div class="form-group">
            ...
            <select class="form-control select2_comp" id="dealer_creation_id" style="width:100%;" onchange="getmarket();gettally_no();">
                <option value="">Select</option>
    ...
    <div class="col-md-2">
        <div class="form-group">
            ...
            <input type="text" id="credit_note_no" class="form-control" placeholder="Credit Note No">
