<form
    action="javascript:insert_update_row('',order_date.value,dealer_creation_id.value,dealer_address.value,mop.value,order_no.value,status1.value,description.value,sales_exec.value)">
    <div class="row">
        <div class="col-md-2">
