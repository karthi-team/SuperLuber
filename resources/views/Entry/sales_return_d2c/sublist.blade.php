...
<table class="table table-sm table-hover" style="width:100%;">
    <thead>
        <tr class="text-center">
            ...
            <th scope="col">Order Rep Desc</th>
    ...
    <tbody>
        <tr>
            <?php $order_date_sub="";$time_sub="";$tally_no="";$desc="";$batch_no="";$return_type_id="";$group_creation_id="";$item_creation_id="";$short_code_id="";$order_quantity="";$pieces_quantity="";$item_property="";$item_weights="";$item_price="";$total_amount="";
            if($sales_return_d2c_sub!=null){
                ...
                $desc=$sales_return_d2c_sub['desc'];
            ...
            <td style="display: none;">
                <input type="date" style="width: auto;" id="order_date_sub" name="order_date_sub" class="form-control" value="<?php if($order_date_sub!='') { echo $order_date_sub; }else { echo date("Y-m-d"); } ?>" readonly>
            ...
            <td>
                <select class="form-control select2_comp1" id="tally_no" style="width:100%;" onchange="descs()">
                    <option value="">Select</option>
                    <?php foreach($tally_no_main as $tally_no1){ ?>
                        <option value="<?php echo $tally_no1['id']; ?>" <?php if($tally_no1['id']==$tally_no){echo " selected";} ?>><?php echo $tally_no1['tally_no']; ?></option>
                        <?php } ?>
                </select>
            </td>

            <td>
                <select class="form-control select2_comp1" id="desc" name="desc" style="width:100%;">
                    <option value="">Select</option>
                </select>
            </td>
        ...
        <tr>
            ...
            <td style="display: none;"
            ><?php echo $sales_return_d2c_sub_list1['order_date_sub']; ?></td>
            ...
            <td><?php echo $sales_return_d2c_sub_list1['desc']; ?></td>
