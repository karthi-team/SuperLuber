...
@section('page_title','Return Entry (D -> C)')
...
<input type="hidden" id="CUR_ACTION" value="{{ route('Sales_Return_D2C_Action') }}" />
<div class="row">
  <div class="col-md-12">
    <div class="card">
      <div class="card-header">
        <h4><span class="label info small">Return Entry (D -> C)</span></h4>
        <div class="card-header-action" id="user_rights_add_div">
          <button type="submit" class="button" onclick="open_model(' Return Entry (D -> C)','')">Create</button>
        </div>
      </div>
      <div class="card-body">
        <div class="row">
          ...
          <div class="col-md-2">
            <div class="form-group">
              <label for="order_no_1">Return Number</label>
          ...
          <div class="col-md-1">
            <div class="form-group">
              <label>&nbsp;</label><br>
              <button class="btn btn-info" onclick="list_div(from_date_1.value,to_date_1.value,sales_exec_1.value,dealer_creation_id_1.value,order_no_1.value)">GO</button>
            </div>
          </div>
        </div>
      </div>
...
<script src="../assets/js/page/Entry/sales_return_d2c.js"></script>
@endsection
