<form action="javascript:insert_update_row('',stock_entry_date,dealer_creation_id.value,dealer_address.value,order_no.value,status1.value,description.value,sales_exec.value)">

<div class="row">
    <div class="col-md-3">
        <div class="form-group">
            <label>Stock Entry Date </label>
            <input type="date" id="stock_entry_date" class="form-control" value="<?php echo date("Y-m-d"); ?>">
        </div>
    </div>
    <div class="col-md-3">
        <div class="form-group">
    ...
    <div class="col-md-3">
        <div class="form-group">
            ...
            <select class="form-control select2_comp" id="dealer_creation_id" style="width:100%;" onchange="getaddress();">
                <option value="">Select</option>
