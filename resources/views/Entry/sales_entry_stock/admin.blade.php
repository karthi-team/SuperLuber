...
@section('page_title','Party Opening Stock')
...
<input type="hidden" id="CUR_ACTION" value="{{ route('Sales_Order_Stock_Action') }}" />
<div class="row">
  <div class="col-md-12">
    <div class="card">
      <div class="card-header">
        <h4><span class="label info small">Party Opening Stock Entry</span></h4>
        <div class="card-header-action" id="user_rights_add_div">
          <button type="submit" class="button" onclick="open_model('Party Opening Stock Entry','')">Create</button>
        </div>
      </div>
      <div class="card-body">
        <div class="row">
          ...
          <div class="col-md-2">
            <div class="form-group">
            <label for="sales_exec_1">Sales Executive</label>
                <select class="form-control select2" id="sales_exec_1" style="width:100%;" onchange="getdearlername_admin()">
          ...
          <div class="col-md-2">
            <div class="form-group">
              ...
              <select class="form-control select2" id="dealer_creation_id_1" width="100%" onchange="getordernumber_admin()">
                <option value="">Select</option>
          ...
          <div class="col-md-2">
            <div class="form-group">
              <label for="order_no_1">Stock Number</label>
          ...
          <div class="col-md-1">
            <div class="form-group">
              <label>&nbsp;</label><br>
              <button class="btn btn-info" onclick="list_div(from_date_1.value,to_date_1.value,order_no_1.value,dealer_creation_id_1.value,sales_exec_1.value)">GO</button>
            </div>
          </div>
        </div>
      </div>
...
<script src="../assets/js/page/Entry/sales_order_stock.js"></script>
@endsection
