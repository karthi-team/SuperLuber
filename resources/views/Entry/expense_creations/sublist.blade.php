    ...
    <table class="table table-sm table-hover" style="width:100%;">
        <thead>
            <tr class="text-center">
                ...
                <th scope="col" style="width:16%;">Total Amount</th>
        ...
        <tbody>
            <tr>
                ...
                <td>
                    ...
                    data-html="true"
                    data-content="<img src='{{ $image_name != '' ? asset('storage/expense_img/' . $image_name) : asset('storage/default/default_image.png') }}' width='300' height='300' style='display: block; margin: auto;' alt='Zoomed Image'>" />
                ...
                <td class="text-center">
                    ...
                    <button type="button" class="btn btn-success btn-action" id="sublist_edit"
                        onclick="insert_update_sub_row('<?php echo $main_id; ?>','<?php echo $sub_id; ?>',total_amount.value)">Add</button>
                    <?php }else{ ?>
                    <button type="button" class="btn btn-primary btn-action" id="sublist_edit"
                        onclick="insert_update_sub_row('<?php echo $main_id; ?>','<?php echo $sub_id; ?>',total_amount.value)">Edit</button>
                    <?php } ?>
                </td>
            </tr>
            <?php
...
$(document).on('click', '.close-child-modal', function (e) {
    e.stopPropagation();
});
</script>
    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            <div class="modal-body text-center">
                ...
                <img id="modalImage" src="" alt="Full Image" style="max-width: 100%; height: 200px; ">
            </div>
