<form action="javascript:insert_update_row('',order_date.value,order_no.value,tally_no.value,manager_id.value,sales_exec.value,dealer_creation_id.value)">
    ...
    <div class="row">
        ...
        <div class="col-md-3">
            <div class="form-group">
                ...
                <select class="form-control select2_comp" id="tally_no" style="width:100%;"  onchange="hide_sublist(tally_no.value),getorderrecipt(),hide_ledger_name(),toggleInput(this.value)">
    ...
    <div></div>
    <div id="sublist_div" style="display: block;"></div>
