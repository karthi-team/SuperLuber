<form action="javascript:insert_update_row('', entry_date.value, target_number.value, sales_executive_id.value, description.value)">
    <div class="row">
        <div class="col-md-3">
        ...
        <div class="col-md-3">
            <div class="form-group">
                ...
                <input type="text" id="target_number" class="form-control" value="<?php echo $target_number; ?>" readonly>
                <div id="entry_date_validate_div" class="mark_label_red"></div>
            </div>
        </div>
        ...
        <div class="col-md-3">
            <div class="form-group">
                ...
                <select id="sales_executive_id" class="form-control" onchange="load_model_sublist('', this.value);">
