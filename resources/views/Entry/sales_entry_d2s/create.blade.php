...
<div class="row">
    ...
    <!-- <div class="col-md-2">
        <div class="form-group">
            ...
            <select class="form-control select2_comp" id="market_creation123_id" name="market_creation_id[]" style="width:100%;" multiple="" onchange="getshop()">
                <option value="">Select</option>
    ...
    <?php         if(isset($_POST['market_creation_id'])) {
 $selectedMarketIds = $_POST['market_creation_id'];
$marketIdsString = implode(',', $selectedMarketIds);
echo "Selected Market IDs as string: " . $marketIdsString;
            } ?>
        </div>
    </div>
</div>
