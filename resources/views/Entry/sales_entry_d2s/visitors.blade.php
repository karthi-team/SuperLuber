...
<form  action="javascript:visitors_insert_update_row('',d2s_id.value,order_date.value,order_no.value,visitor_dis.value,visitor_name.value,sales_exec.value,mobile_no.value,description.value,address.value,dealer_id.value)" enctype="multipart/form-data">
<div class="row">
      <div class="col-md-3">
    ...
    <div class="col-md-3">
        <div class="form-group">
            ...
            <select class="form-control select2_comp" id="dealer_id" >
                ...
                <option value="<?php echo $dealer_creation['id']; ?>"><?php echo $dealer_creation['dealer_name']; ?></option>
                <?php } ?>
            </select>
    ...
    <div class="col-md-3">
        <div class="form-group">
            ...
            <input type="text" id="visitor_dis" class="form-control">
